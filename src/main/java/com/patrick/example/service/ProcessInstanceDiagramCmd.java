...
/**
 * Desciption 根据流程实例ID生成流程图
 * Create By  li.bo
 * CreateTime 2017/7/5 16:39
 * UpdateTime 2017/7/5 16:39
 */
public class ProcessInstanceDiagramCmd{
    ...
    public ProcessInstanceDiagramCmd(String processInstanceId, RuntimeService runtimeService, RepositoryService repositoryService, ProcessEngine processEngine, HistoryService historyService) {
    ...
    public InputStream executeDyanmicDiagram() {
...
//        Context.setProcessEngineConfiguration(processEngine.getProcessEngineConfiguration());
        ...
        InputStream imageStream = new DefaultProcessDiagramGenerator().generateDiagram(bpmnModel, "png", activeActivityIds, highLightedFlows);
